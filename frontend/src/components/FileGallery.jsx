...
const FileGallery = () => {
    ...
    // Calcular conteos de archivos por tipo de forma segura
            ...
            {filteredFiles.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                    {filteredFiles.map((file, index) => (
                        <div key={index} className="border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition duration-200">
                            {/* Preview del archivo */}
                            <div className="h-32 bg-gray-100 flex items-center justify-center overflow-hidden">
                                {file.type === 'image' ? (
                                    <img 
                                        ...
                                        loading="lazy"
                                        onError={(e) => {
                                            // Si falla la carga de la imagen, mostrar el icono
